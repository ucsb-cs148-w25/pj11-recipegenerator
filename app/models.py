...
class GenerateRecipesResponse(BaseModel):
    ...
    Contains a single string representing the model-generated recipes.
    """
    # A string containing the text output of three recipe suggestions generated by the ML function
    recipes: str = Field(..., description="String of generated recipe suggestions.")
